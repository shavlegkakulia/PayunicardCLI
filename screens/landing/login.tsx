...
const LoginForm: React.FC = () => {
    ...
    const Header = () => {
        ...
        return <View style={headerContainerStyle}>
            <Text style={styles.authorizeText}>{translate.t('login.authorize')}</Text>
            <TouchableOpacity onPress={async () => { dispatch(use(translate.next())) }}>
        ...
        <View style={styles.container}>
            ...
            <View>
                ...
                <View style={styles.toolContainer}>
                    <AppCheckbox label={translate.t('login.remember')} labelStyle={styles.forgotLabelColor} activeColor={colors.primary} value={remember} clicked={_remember} style={{}} />
                    <TouchableOpacity><Text style={styles.forgotLabel}>{translate.t('login.forgotpassword')}</Text></TouchableOpacity>
                </View>
                <View style={buttonContainerStyle}>
                    <AppButton title={translate.t('login.login')} onPress={login} isLoading={state.isLoading} />
                    <AppButton backgroundColor={`${colors.white}`} color={`${colors.black}`} title={translate.t('login.signup')} onPress={() => navigation.navigate('Signup')} />
                </View>
            </View>
        </View>
    )
