...
import { ITranslateState, IGlobalState } from '../../redux/action_types/translate_action_types';
...
const LoginWithPassword: React.FC<IProps> = ({ UserData, userPassword, isLoading, onLogin, onSetPassword, onDismiss = Function, }) => {
    const translate = useSelector<IGlobalState>(state => state.TranslateReduser) as ITranslateState;
    const state = useSelector<IAuthGlobalState>(state => state.AuthReducer) as IAuthState;
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.inputsView}>
                <View style={styles.inputsContainer}>
                    <AppInput
                        ...
                        onChange={(password) => { onSetPassword(password) }} />
                </View>
            ...
            <ActionSheetCustom
                ...
                <PasswordReset onComplate={passwordResetStepClose} />
            </ActionSheetCustom>
        </View>
    )
}
