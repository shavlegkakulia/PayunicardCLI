import { DEV_API, PROD_API, TEST_CONNECT_API, TEST_API, PROD_CONNECT_API, _DEV_CONNECT_API, TOKEN_TTL, CDN_PATH, client_id, client_secret, client_id_dev, client_secret_dev } from '@env';
